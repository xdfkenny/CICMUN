  ...
  <div class="min-h-screen bg-gray-50 py-12 px-4">
    <div class="container max-w-4xl mx-auto">
      ...
      <div class="flex justify-center mb-12">
        <div class="bg-gray-200 p-1 rounded-xl inline-flex shadow-inner" role="tablist" aria-label="Conference Tabs">
          <button 
      ...
      <div class="space-y-12" :id="`panel-${activeTab}`" role="tabpanel" :aria-labelledby="`tab-${activeTab}`" tabindex="0">
        <!-- Loading State -->
