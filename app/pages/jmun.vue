  ...
  <div class="min-h-screen bg-gray-50 py-12 px-4">
    <div class="container max-w-6xl mx-auto">
      ...
      <div class="mb-12 animate-fade-in-up">
        <h1 class="text-5xl md:text-6xl font-bold text-black mb-4 font-montserrat tracking-tight uppercase">{{ eventDetails?.name || 'JMUN 2026' }}</h1>
      ...
      <div class="max-w-4xl mx-auto mb-20 reveal">
        ...
        <div class="bg-white p-6 md:p-10 rounded-2xl border-l-8 border-black shadow-xl overflow-hidden hover-lift transition-all duration-500">
          <h2 class="text-3xl font-bold text-black mb-8 font-montserrat uppercase tracking-tight">Event Details</h2>

          <div class="grid md:grid-cols-2 gap-10">
            <div class="space-y-6">
              <div class="flex items-start gap-5 group">
                <div class="bg-gray-50 p-3 rounded-xl transition-transform duration-300 group-hover:scale-110 group-hover:bg-gray-100">
                  ...
                  <div class="hidden md:block">
                    ...
                    <div v-if="eventDetails?.externalMapUrl" class="mt-6">
                      <a :href="eventDetails.externalMapUrl" target="_blank" rel="noopener noreferrer">
                        <UiButton size="default" class="flex items-center gap-2 bg-black text-white hover:bg-gray-800 transition-all shadow-lg hover:shadow-black/20 transform hover:-translate-y-1">
      ...
      <!-- Committees Section -->
      <div>
        <h2 class="text-3xl font-bold text-black mb-8 font-montserrat uppercase tracking-tight reveal">JMUN Committees</h2>
